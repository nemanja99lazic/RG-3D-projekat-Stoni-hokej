...
public class MenuChoosePaddle extends Menu{
    ...
    public MenuChoosePaddle()
    {
        ...
        Text textPaddle1 = new Text("T paddle");
        Text textPaddle2 = new Text("Box paddle");
        Text textPaddle3 = new Text("Red paddle");

        textPaddle1.setFont(Font.font(FONT_SIZE));
        textPaddle1.getTransforms().add(
                new Translate(30, SIZE / 3 - FONT_SIZE / 2)
        );

        textPaddle2.setFont(Font.font(FONT_SIZE));
        textPaddle2.getTransforms().add(
                new Translate(30, 2 * SIZE / 3 - FONT_SIZE / 2)
        );

        textPaddle3.setFont(Font.font(FONT_SIZE));
        textPaddle3.getTransforms().add(
                new Translate(30, SIZE - FONT_SIZE / 2)
        );

        root.getChildren().addAll(background, triangle, textPaddle1, textPaddle2, textPaddle3);
